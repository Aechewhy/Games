...
BloodRefund: fixed blood refund free mode still requiring you to have the keys refunding would have cost
Commendations : fixed a typo in the Trove Taker commendation
CompleteAllBounties: fixed bounties being rewarded for heat 1-5 on hell mode
CompleteAllBounties: fixed diamond and ambrosia bounties not being rewarded

changes :

Commendations : entries in the Commendations tab no longer have stars on either side, which caused the formatting to be weird