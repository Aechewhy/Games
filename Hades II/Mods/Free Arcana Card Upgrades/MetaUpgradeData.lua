...
MetaUpgradeCardData = 
{
	...
	ChanneledCast = -- Sorceress, Medea
	{
		...
		{
			{ CardUpgradePoints =  0 },
			{ CardUpgradePoints =  0, MixerHBoss =  0 },
		},
	...
	HealthRegen = -- Wayward Son, Zagreus
	{
		...
		{
			{ CardUpgradePoints =  0 },
			{ CardUpgradePoints =  0, MixerFBoss =  0, },
		},
	...
	LowManaDamageBonus = -- Huntress, Artemis
	{
		...
		{
			{ CardUpgradePoints =  0 },
			{ CardUpgradePoints =  0, MixerNBoss =  0, },
		},
	...
	SorceryRegenUpgrade = -- Moon, Selene
	{
		...
		{
			{ CardUpgradePoints =  0 },
			{ CardUpgradePoints =  0, MixerGBoss =  0, },
		},
	...
	BonusHealth = -- Persistence, Prometheus
	{
		...
		{
			{ CardUpgradePoints =  0 },
			{ CardUpgradePoints =  0, MixerPBoss =  0 },
		},
	...
	MagicCrit = -- Night, Nyx
	{
		...
		{
			{ CardUpgradePoints =  0, },
			{ CardUpgradePoints =  0, Mixer6Common =  0 },
		},
	...
	LastStand = -- Death, Thanatos
	{
		...
		{
			{ CardUpgradePoints =  0 },
			{ CardUpgradePoints =  0, Mixer5Common =  0 },
		},
	...
	MaxHealthPerRoom = -- Centaur, Chiron
	{
		...
		{
			{ CardUpgradePoints =  0, },
			{ CardUpgradePoints =  0, MixerOBoss =  0 },
		},
	...
	StatusVulnerability = -- Origination, Chaos
	{
		...
		{
			{ CardUpgradePoints =  0 },
			{ CardUpgradePoints =  0, MixerShadow =  0, },
		},
	...
	StartingGold = -- Boatman, Charon
	{
		...
		{
			{ CardUpgradePoints =  0 },
			{ CardUpgradePoints =  0, CharonPoints =  0 },
		},
	...
	CardDraw = -- Judgment, Hades
	{
		...
		{
			{ CardUpgradePoints =  0, },
			{ CardUpgradePoints =  0, MetaFabric =  0 },
		},
