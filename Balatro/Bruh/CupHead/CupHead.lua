...
--- PREFIX: CH
--- MOD_AUTHOR: [Mahuru]
--- MOD_DESCRIPTION: Cuphead, pixelarts by @nandoo.px.
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: 480809

local atlas_key = 'CH_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'CH_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'CH_hc.png' -- Filename for the high-contrast version of the texture, if existing

local suits = {'hearts'} -- Which suits to replace
local ranks = {'Jack', 'Queen', "King"} -- Which ranks to replace

local description = 'CupHead' -- English-language description, also used as default
