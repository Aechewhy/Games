--- STEAMODDED HEADER
--- MOD_NAME: Hollow Knight Cards
--- MOD_ID: hk_deck
--- PREFIX: hk
--- MOD_AUTHOR: [Galeandra]
--- MOD_DESCRIPTION: Hollow Knight cards by Galeandra
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: 480809

local atlas_key = 'hk' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'hk_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'hk_hc.png' -- Filename for the high-contrast version of the texture, if existing
