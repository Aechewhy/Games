--- STEAMODDED HEADER
--- MOD_NAME: Hades Cards
--- MOD_ID: hades
--- PREFIX: hades
--- MOD_AUTHOR: [Galeandra]
--- MOD_DESCRIPTION: Hades cards by Galeandra
...
local atlas_path = 'hades_lc.png' -- Filename for the image in the asset folder
--local atlas_path_hc = 'hades_hc.png' -- Filename for the high-contrast version of the texture, if existing
